...
Copy-Item docs\RELEASE_V1.5.0.md "$dist\RELEASE_NOTES.md"
...
Write-Host "gh release create $tag $dist/* $archive --title 'DEADGL $tag' --notes-file docs/RELEASE_V1.5.0.md"
